package wtf.bella.kamiblue.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static wtf.bella.kamiblue.gui.rgui.render.util.ShaderHelper.createProgram;
import static wtf.bella.kamiblue.gui.rgui.render.util.ShaderHelper.loadShader;
