package wtf.bella.kamiblue.gui.kami;

import com.mojang.realmsclient.gui.ChatFormatting;
import wtf.bella.kamiblue.KamiBlueMod;
import wtf.bella.kamiblue.command.Command;
import wtf.bella.kamiblue.gui.kami.component.ActiveModules;
import wtf.bella.kamiblue.gui.kami.component.Radar;
import wtf.bella.kamiblue.gui.kami.component.SettingsPanel;
import wtf.bella.kamiblue.gui.kami.theme.kami.KamiTheme;
import wtf.bella.kamiblue.gui.rgui.GUI;
import wtf.bella.kamiblue.gui.rgui.component.container.use.Frame;
import wtf.bella.kamiblue.gui.rgui.component.container.use.Scrollpane;
import wtf.bella.kamiblue.gui.rgui.component.listen.MouseListener;
import wtf.bella.kamiblue.gui.rgui.component.listen.TickListener;
import wtf.bella.kamiblue.gui.rgui.component.use.CheckButton;
import wtf.bella.kamiblue.gui.rgui.component.use.Label;
import wtf.bella.kamiblue.gui.rgui.render.theme.Theme;
...
import wtf.bella.kamiblue.module.modules.sdashb.util.CalcPing;
import wtf.bella.kamiblue.module.modules.sdashb.gui.InfoOverlay;
import wtf.bella.kamiblue.util.ColourHolder;
import wtf.bella.kamiblue.util.LagCompensator;
import wtf.bella.kamiblue.util.Pair;
    ...
    public void initializeGUI() {
        ...
        information.addTickListener(() -> {
            ...
            if (ModuleManager.getModuleByName("InfoOverlay").isEnabled()) {
                information.setText("");
                information.addLine("\u00A7b" + KamiBlueMod.KAMI_KANJI + "\u00A73 " + KamiBlueMod.MODVER);
                if (privateInfoNam) {
