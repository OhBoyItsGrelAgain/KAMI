package wtf.bella.kamiblue.command;
...
public abstract class Command {
	...
	public static void sendChatMessage(String message){
		sendRawChatMessage("&7[&a" + KamiBlueMod.KAMI_KANJI + "&7] &r" + message);
	}
	
	public static void sendErrorMessage(String message){
		sendRawChatMessage("&7[&4" + KamiBlueMod.KAMI_KANJI + "&7] &r" + message);
	}

	public static void sendWarningMessage(String message){
		sendRawChatMessage("&7[&6" + KamiBlueMod.KAMI_KANJI + "&7] &r" + message);
	}
