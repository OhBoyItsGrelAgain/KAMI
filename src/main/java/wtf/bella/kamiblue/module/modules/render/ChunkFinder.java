...
import wtf.bella.kamiblue.event.events.ChunkEvent;
...
public class ChunkFinder extends Module {
    ...
    private void logWriterOpen() {
        ...
        try {
            ...
            e.printStackTrace();
            KamiBlueMod.log.error("some exception happened when trying to start the logging -> " + e.getMessage());
        ...
        */
        ...
        if (mc.isSingleplayer()) {
            try {
                ...
                e.printStackTrace();
                KamiBlueMod.log.error("some exception happened when getting canonicalFile -> " + e.getMessage());
        ...
        try {
            ...
            e.printStackTrace();
            KamiBlueMod.log.error("some exception happened when trying to make the file -> " + e.getMessage());
