...
import static wtf.bella.kamiblue.util.BlockInteractionHelper.*;
...
public class Auto32k extends Module {
	...
	protected void onEnable() {
		...
		List<BlockPos> placeTargetList = crystalAura.getSphere(CrystalAura.getPlayerPos(), range, range, false, true, 0);
