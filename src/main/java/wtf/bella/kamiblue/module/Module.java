package wtf.bella.kamiblue.module;
...
public class Module {
    ...
    public void enable() {
        ...
        onEnable();
        if (!alwaysListening)
            KamiBlueMod.EVENT_BUS.subscribe(this);
    }
    ...
    public void disable() {
        ...
        onDisable();
        if (!alwaysListening)
            KamiBlueMod.EVENT_BUS.unsubscribe(this);
    }
    ...
    protected final void setAlwaysListening(boolean alwaysListening) {
        ...
        if (alwaysListening) KamiBlueMod.EVENT_BUS.subscribe(this);
        if (!alwaysListening && isDisabled()) KamiBlueMod.EVENT_BUS.unsubscribe(this);
    }
